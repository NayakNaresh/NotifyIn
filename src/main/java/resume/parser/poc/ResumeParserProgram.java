...
public class ResumeParserProgram {
	...
	public static JSONObject loadGateAndAnnie(File file) throws GateException,
		...
		System.setProperty("gate.home", "D:\\startup\\workruit\\ResumeParser\\ResumeParser\\GATEFiles"); 
		Gate.init();
	...
	public static void main(String[] args) {
		...
		String inputFileName = "D:\\startup\\workruit\\Kripanshu_CV.doc";
		/*String outputFileName = (args.length == 2) ? args[1]
				: "D:\\nayak\\parsed_resume.json";*/
		
		String outputFileName = "D:\\nayak\\parsedresume.json";
		try {
